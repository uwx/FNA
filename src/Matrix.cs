...
namespace Microsoft.Xna.Framework
{
	public static class MatrixExtensions
	{
		...
		extension(Matrix m)
		{
			...
			{
				get { return new Vector3(m.M31, m.M32, m.M33); }
				set
				{
					m.M31 = value.X;
					m.M32 = value.Y;
			...
			public Vector3 Down
			{
				get { return new Vector3(-m.M21, -m.M22, -m.M23); }
				set
				{
					m.M21 = -value.X;
					m.M22 = -value.Y;
			...
			public Vector3 Left
			{
				get { return new Vector3(-m.M11, -m.M12, -m.M13); }
				set
				{
					m.M11 = -value.X;
					m.M12 = -value.Y;
			...
			{
				get { return new Vector3(m.M41, m.M42, m.M43); }
				set
				{
					m.M41 = value.X;
					m.M42 = value.Y;
			...
			{
				float num18 = (m.M33 * m.M44) - (m.M34 * m.M43);
				float num17 = (m.M32 * m.M44) - (m.M34 * m.M42);
				float num16 = (m.M32 * m.M43) - (m.M33 * m.M42);
				float num15 = (m.M31 * m.M44) - (m.M34 * m.M41);
				float num14 = (m.M31 * m.M43) - (m.M33 * m.M41);
				float num13 = (m.M31 * m.M42) - (m.M32 * m.M41);
				return (
					(
						(
							(m.M11 * (((m.M22 * num18) - (m.M23 * num17)) + (m.M24 * num16))) -
							(m.M12 * (((m.M21 * num18) - (m.M23 * num15)) + (m.M24 * num14)))
						) + (m.M13 * (((m.M21 * num17) - (m.M22 * num15)) + (m.M24 * num13)))
					) - (m.M14 * (((m.M21 * num16) - (m.M22 * num14)) + (m.M23 * num13)))
				);
			}
			...
			)
			{
				...
				Multiply(in value, in rotMatrix, out result);
			}
